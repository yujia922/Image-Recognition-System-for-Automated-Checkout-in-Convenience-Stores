...
## Technical Approach
This project aims to build an automated checkout system for convenience stores using computer vision. We will focus on snack products (especially chips) as the initial category.
### 1. Data Collection
...
After data collection, we will annotate each individual product instance using a bounding-box based labeling tool (e.g. LabelImg / RoboFlow).
